...
$(function() {
	...
	navOpener.on('click', function() {
		...
		slideNav.toggleClass('nav-active');
...
$(function initMap() {
	var uluru = {lat: 49.993, lng: 36.232};
    ...
    var contentString = '<div class="tooltip">'+
			'<strong>Blue Avenue #33, King Leonardo 33821</strong>'+
			'<span>+82394 5940</span>'+
			'<button class="btn">send us an email</button>'+
			'</div>';
